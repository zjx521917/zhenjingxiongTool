...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of zhenjingxiongTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/镇景雄/zhenjingxiongTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '镇景雄' => '1694615244@qq.com' }
  s.source           = { :git => 'https://github.com/镇景雄/zhenjingxiongTool.git', :tag => s.version.to_s }
